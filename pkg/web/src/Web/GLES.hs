...
import Prelude
import qualified JavaScript.Web.Canvas as JS
import qualified JavaScript.TypedArray as JS
import qualified JavaScript.TypedArray.ArrayBuffer as JS
import qualified Web.GLES.Const as JS
import qualified Web.GLES.Raw as JS
import qualified Web.GLES.Types as JS
...
instance GLES where
        ...
        glGetProgramParameterBool (_, c) (TagProgram _ p) = JS.glGetProgramParameterBool c p
        ...
        glTexImage2DImage = JS.glTexImage2DImage . snd
